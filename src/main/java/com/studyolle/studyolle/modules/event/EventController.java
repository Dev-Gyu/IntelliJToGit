...
public class EventController {
    ...
    public String events_delete(@CurrentUser Account account, @PathVariable String path, @PathVariable Long id){
        Study study = studyRepository.findStudyManagerByPath(path);
        studyService.authCheck(account, study);
        eventService.deleteEvent(eventRepository.findById(id).orElseThrow(), study);
    ...
    public String enroll_checkin(@CurrentUser Account account, @PathVariable("eventId") Event event, @PathVariable("enrollId") Enrollment enrollment,
    ...
    @PostMapping("events/{eventId}/enrollments/{enrollId}/cancelCheckin")
    public String enroll_cancelCheckin(@CurrentUser Account account, @PathVariable("eventId") Event event, @PathVariable("enrollId") Enrollment enrollment,
                                 @PathVariable String path, Model model){
        Study study = studyRepository.findStudyManagerByPath(path);
        studyService.authCheck(account, study);
    ...
    public String enroll_accept(@CurrentUser Account account, @PathVariable("eventId") Event event, @PathVariable("enrollId") Enrollment enrollment,
                                       @PathVariable String path, Model model){
        Study study = studyRepository.findStudyManagerByPath(path);
        studyService.authCheck(account, study);
    ...
    public String enroll_reject(@CurrentUser Account account, @PathVariable("eventId") Event event, @PathVariable("enrollId") Enrollment enrollment,
                                       @PathVariable String path, Model model){
        Study study = studyRepository.findStudyManagerByPath(path);
        studyService.authCheck(account, study);
